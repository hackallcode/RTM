...
#error "Don't use AudioEngine and SimpleAudioEngine at same time. Please just select one in your game!"
#endif
...
// if you want different context, modify value of glContextAttrs
...
// if you want to use package manager to install more packages,  
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    // set FPS. default value is 1.0/60 if you don't call this
    ...
    // create scene. it's autorelease object
...
// This function will be called when app is inactive. Note, when receiving phone call it is invoked.
...
// this function will be called when app is active again
